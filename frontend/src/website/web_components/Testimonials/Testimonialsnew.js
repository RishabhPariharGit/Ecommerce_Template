...
const Testimonialsnew = () => {
  const testimonials = [
    ...
    },
    {
      ...
      text:
        "I had my concerns that due to a tight deadline this project can't be done. But this guy proved me wrong not only did he deliver outstanding work, but he managed to deliver a day prior to the deadline. And when I asked for some revisions, he made them in MINUTES. I'm looking forward to working with him again and I totally recommend him."
    },
    {
      name: "Sasha Ho",
      position: "Accountant",
  ...
  const { name, position, photo, text } = testimonials[currentTestimonial];
