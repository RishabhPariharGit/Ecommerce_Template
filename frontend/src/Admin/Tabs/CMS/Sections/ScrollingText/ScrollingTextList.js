...
import {
    getAllScrollingTexts,
    deleteScrollingText,
} from '../../../../../Services/AdminServices/Allservices/ScrollingTextService';
...
const ScrollingTextList = () => {
    ...
    const handleEdit = (id) => {
        navigate(`/admin/ScrollingText/edit/${id}`);
    };

    const handleCreate = () => {
        navigate('/admin/ScrollingText/create');
    };

    const handleDelete = async (id) => {
        if (
            window.confirm(
                'Are you sure you want to delete this ScrollingText? This will also delete related data.'
            )
        ) {
            try {
...
export default ScrollingTextList;
